...
public class TabBarActivity extends TabActivity implements OnTabChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		spec = tabHost.newTabSpec("First").setIndicator("", res.getDrawable(R.drawable.first_tab)).setContent(intent);
		tabHost.addTab(spec);

		intent = new Intent().setClass(this, CreateActivityActivity.class);
		spec = tabHost.newTabSpec("Second").setIndicator("", res.getDrawable(R.drawable.second_tab)).setContent(intent);
		tabHost.addTab(spec);

		intent = new Intent().setClass(this, ProfileActivity.class);
		spec = tabHost.newTabSpec("Third").setIndicator("", res.getDrawable(R.drawable.third_tab)).setContent(intent);
		tabHost.addTab(spec);
