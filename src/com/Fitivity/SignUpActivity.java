					...
					public void run() {
						try {
							...
							if (password.length() < 6) {
								passwordfailHandler
										.sendMessage(passwordfailHandler
												.obtainMessage());
								return;
							}
							if (password.length() > 15) {
								passwordfail2Handler
										.sendMessage(passwordfail2Handler
												.obtainMessage());
								return;
							}
							if (username.length() < 6) {
								usernamefailHandler
										.sendMessage(usernamefailHandler
												.obtainMessage());
								return;
							}
							if (username.length() > 15) {
								usernamefail2Handler
										.sendMessage(usernamefail2Handler
												.obtainMessage());
								return;
							}
							if (!confirm.equals(password)) {
								confirmfailHandler
										.sendMessage(confirmfailHandler
												.obtainMessage());
								return;
							}
							...
							/*
							 * Finish splash activity so user cant go back to
							 * it.
							 */
